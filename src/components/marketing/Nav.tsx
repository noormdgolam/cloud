    ...
    <header className="sticky top-0 z-50 px-4 pt-4 sm:px-6">
      <div className="glass mx-auto flex max-w-6xl items-center justify-between rounded-full px-4 py-2.5 sm:px-5">
        ...
        <nav className="hidden items-center gap-6 text-sm text-ink-muted sm:flex">
          ...
          <a href="#tools-showcase" className="transition-colors hover:text-ink">
            Tools
          </a>
          <a href="#comparison" className="transition-colors hover:text-ink">
            Comparison
          </a>
          <a href="#calculator" className="transition-colors hover:text-ink">
            Calculator
          </a>
        ...
        <div className="flex items-center gap-2">
          <ThemeToggle />
          {loggedIn ? (
            <LinkButton href="/dashboard" variant="accent" className="px-4 py-2 text-sm">
              Go to dashboard
            </LinkButton>
          ) : (
            <>
